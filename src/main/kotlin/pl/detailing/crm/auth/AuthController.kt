...
class AuthController(
    ...
    fun login(
        ...
        val response = loginHandler.handle(request)

        httpRequest.session.setAttribute("SPRING_SECURITY_CONTEXT",
    ...
    @PostMapping("/logout")
    fun logout(httpRequest: HttpServletRequest): ResponseEntity<UnifiedAuthResponse> {
