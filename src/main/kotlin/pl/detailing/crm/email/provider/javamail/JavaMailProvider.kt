 ...
 *
 * There is deliberately no recipient allow-list here. Who may receive a message is
 * decided per studio by the communication redirect switch, applied in
 * [pl.detailing.crm.communication.OutboundCommunicationGateway]; a list baked into the
 * provider would silently block every real customer once deployed.
 */
class JavaMailProvider(
    ...
    companion object {
        private const val FROM_ADDRESS = "no-reply@detailboost.pl"
