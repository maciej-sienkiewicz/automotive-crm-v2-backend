...
enum class AuditAction(
    ...
    ATTENDANCE_SHEET_GENERATED("Wygenerowanie listy obecności", "Wygenerowano listę obecności", AuditIcon.DOCUMENT),
    ATTENDANCE_SHEET_APPROVED("Zatwierdzenie listy obecności", "Zatwierdzono listę obecności", AuditIcon.APPROVE),
    ATTENDANCE_SHEET_DELETED("Usunięcie listy obecności", "Usunięto listę obecności", AuditIcon.DELETE, AuditSeverity.HIGH),
